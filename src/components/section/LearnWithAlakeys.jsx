"use client";
import LearnAlakeysCard from "../card/LearnAlakeysCard";
import { Swiper, SwiperSlide } from "swiper/react";
import "swiper/css";
import "swiper/css/navigation";
import "swiper/css/pagination";
import { Navigation, Pagination } from "swiper";
import { learnAlakeys } from "@/data/project";
import CountUp from "react-countup";
import { usePathname } from "next/navigation";
import { useEffect, useState } from "react";

export default function LearnWithAlakeys() {
          ...
          <div className="row align-items-md-center">
            ...
            >
              <div className="main-title">
                <h2 className="title">People Love To Learn With Alakeys</h2>
                  ...
                  <div className="funfact_one">
                    <div className="details">
                      ...
                      <p className="text mb-0">
                        Clients rate professionals on Alakeys
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <div className="col-md-6 col-lg-4 col-xl-4">
              ...
              >
                {showSwiper && (
                  ...
                  >
                    {learnAlakeys.map((item, index) => (
                      <SwiperSlide key={index}>
                        <LearnWithAlakeys data={item} />
                      </SwiperSlide>
                    ))}
                  </Swiper>
                )}
