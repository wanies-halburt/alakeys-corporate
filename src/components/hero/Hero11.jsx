...
export default function Hero11() {
  return (
    <section className="hero-home11 pt90 pb60">
      <div className="container">
        <div className="row align-items-center justify-content-between">
          <div className="col-lg-6 col-xl-6 mb30-md">
            <div className="home11-hero-content">
              <h2 className="title animate-up-2 primary-text-color">
                Grow faster <br />
                <strong className=" secondary-text-color">on Alakeys.</strong>
              </h2>
              <p className="animate-up-3 fs-6">
          ...
          <div className="col-lg-6">
            <div className="home11-hero-img text-center text-xxl-end">
              <Image
                ...
                className="bdrs20"
                src="/images/about/about-13.jpeg"
                alt=" image "
              />
